  ...
  return (
    <div className="relative min-h-screen flex flex-col items-center">
      <div className="absolute top-[65px] w-full flex justify-center px-4 sm:px-0">
        <div className="flex flex-col items-center justify-center w-full max-w-lg h-[100px] bg-[#ebf9fa] rounded-[26px]">
          <div className="text-[#212121] text-2xl sm:text-40px font-abril-fatface leading-6 sm:leading-52px text-center">
            Get a property checked out for you
          </div>
        </div>
      </div>

      <div className="flex flex-col items-center justify-center mt-[200px] space-y-20 px-4">
        <div className="text-[#737373] text-lg sm:text-32px font-red-hat-display font-bold leading-6 sm:leading-42px text-center px-4">
          We go and take photos, videos, and write a report of the properties you were <br />
          interested in moving to
        </div>
        <div className="flex flex-col sm:flex-row items-center mt-[50px] space-y-4 sm:space-y-0">
          <button className="cursor-pointer w-full sm:w-[428px] h-[62px] px-2 border-0 box-border rounded-full bg-accent text-black text-lg font-red-hat-display font-medium leading-6 sm:mr-[150px]">
          ...
          <button className="cursor-pointer w-full sm:w-[428px] h-[62px] px-2 border-0 box-border rounded-full bg-accent text-black text-lg font-red-hat-display font-medium leading-6 sm:ml-[150px]">
            Browse Properties
          </button>
        </div>
      </div>
      ...
      <div className="w-full mt-10 px-4 sm:px-0">
        ...
        <div className="flex flex-col items-center sm:hidden">
          <button onClick={() => setShowFilters(!showFilters)} className="w-full sm:w-auto px-4 py-2 bg-accent text-black font-red-hat-display font-medium text-lg rounded-full">
        ...
        {showFilters && (
          <div className="flex flex-col items-center space-y-4 mt-4 sm:hidden">
            ...
            <button className="w-full sm:w-auto px-4 py-2 bg-accent text-black font-red-hat-display font-medium text-lg rounded-full mt-4">
              Apply
            </button>
          </div>
        )}
      ...
      <div className="hidden sm:flex items-center justify-between w-[1113px] h-[93px] p-4 bg-white rounded-full shadow-lg mt-10">
        ...
        <div className="flex flex-col items-center">
          <span className="font-bold">Bedroom</span>
          <input className="outline-none text-gray-500 text-center" type="text" placeholder="Add how many bedrooms" />
        </div>
        <div className="border-r border-gray-300 h-full"></div>
        <div className="flex flex-col items-center">
          <span className="font-bold">Bathrooms</span>
          <input className="outline-none text-gray-500 text-center" type="text" placeholder="Add how many bathrooms" />
        </div>
        <div className="border-r border-gray-300 h-full"></div>
        <div className="flex flex-col items-center">
          <span className="font-bold">Home Type</span>
            ...
            <div key={index} className="flex flex-col items-center">
              <div className="relative bg-cover bg-center h-48 w-full rounded-md" style={{ backgroundImage: `url(${image})` }}>
                <div className="absolute top-2 right-2 cursor-pointer" onClick={() => toggleSaved(index)}>
                  <svg
                    className={`w-8 h-8 ${saved[index] ? 'text-pink-500' : 'text-gray-400'}`}
                    viewBox="0 0 24 24"
                    fill="currentColor"
                  >
