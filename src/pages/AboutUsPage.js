      ...
      <div className="flex flex-col md:flex-row items-start justify-between">
        <div className="md:w-2/3">
          ...
          <div className="flex justify-center md:justify-start">
            <button className="cursor-pointer mt-4 px-8 py-3 border-0 box-border rounded-full bg-twitterIcon text-white text-lg font-red-hat-display font-medium leading-6">
              Sign Up
            </button>
          </div>
        </div>
